#include <mymuduo/net/http/HttpContext.h>
...
using mymuduo::Timestamp;
using mymuduo::net::Buffer;
using mymuduo::net::HttpContext;
using mymuduo::net::HttpRequest;
...
using mymuduo::net::detail::parseRequest;
