...
BOOST_AUTO_TEST_CASE(testInetAddress)
{
  ...
  InetAddress addr3("255.255.255.256", 65535);
  BOOST_CHECK_EQUAL(addr3.toIp(), string("255.255.255.256"));
  BOOST_CHECK_EQUAL(addr3.toIpPort(), string("255.255.255.256:65535"));
}
